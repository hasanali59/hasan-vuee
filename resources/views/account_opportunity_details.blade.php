...
@section('title', 'Account Opportunity Details')
        ...
        <div class="card" style="margin: 30px 0">
            ...
            <div class="card-body">
                ...
                @foreach($files as $file)
                    <a href="/storage/uploads/account_opportunity/{{$file->file_hash_name}}">{{$file->file_name}}</a><br>
                @endforeach
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/opportunity/account/edit" class="register-form" method="post">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" name="account_id">
                                @foreach($accounts as $account)
                                    @if($account->id == $opportunity->account_id)
    ...
    <div class="modal fade" id="add-note" role="dialog">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="/opportunity/account/add-notes" class="register-form" method="post">
                        @csrf

                        <input type="hidden" value="{{$opportunity->id}}" name="id">
                        <input type="hidden" value="account-opportunity" name="type">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="/opportunity/account/add-file" method="post" enctype="multipart/form-data">
    ...
    <script>
        function confirmDelete() {
            if (confirm('Are you sure you want to delete?')) {
                $.ajax({url: "/opportunity/account/delete/{{$opportunity->id}}", success: function(result){
        ...
        $('#opportunity-won').on('change', function() {
            $.ajax({
                url: "/account/update-opportunity",
                type: 'post',
